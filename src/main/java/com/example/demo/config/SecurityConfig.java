...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
		...
		String[] arr = {"/landmarkComment/register"};
		...
		http
         ...
         .requestMatchers("/member/**","/login","/landmark/**","/landmarkComment/**","/landmarkComment/list").permitAll()
         .requestMatchers("/member/**","/login","/landmark/**","/lc/**","landmarkComment/**").permitAll()
